...
const run = args['report-only'] ? previous : { startedAt: new Date().toISOString(), manifestSha256: null, browser: null, gpu: null, captures: results };
